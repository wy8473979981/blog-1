...
var config = {
	entry: {
		...
		header: path.resolve(__dirname, 'component/header/header.js'),
		vendors: ['react', 'react-dom']
	},

	output: {
		path: path.resolve(__dirname, 'build/js'),//打包的路径 不是webpack-dev-server的路径
		publicPath: 'server',
	...
	//	},
	plugins: [
		new ExtractTextPlugin('./css/[name].css'), //输出独立的css文件,用于external link形式,如果有多个入口JS共用的CSS,会生成commons.css 可以加上hash值 防止缓存
